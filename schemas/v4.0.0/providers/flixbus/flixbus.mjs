    ...
    tools: {
        autocompleteCities: {
            ...
            parameters: [
                ...
                {
                    position: {
                        key: 'flixbus_cities_only',
                        value: '{{USER_PARAM}}',
                        location: 'query'
                    },
                    z: {
                        primitive: 'enum(true,false)',
            ...
            tests: [
                {
                    _description: 'Search for Berlin cities',
                    q: 'Berlin',
                    lang: 'en',
                    country: 'de'
                },
                {
                    _description: 'Search for Paris cities',
                    q: 'Paris',
                    lang: 'en'
                },
                {
                    _description: 'Search for Munich in German',
                    q: 'Muenchen',
                    lang: 'de',
                    country: 'de'
                }
                ...
                schema: {
                    ...
                    items: {
                        ...
                        properties: {
                            id: {
                                type: 'string',
                                description: 'City UUID for use in trip search'
                            },
                            name: {
                                type: 'string',
                            ...
                            country: {
                                type: 'string',
                                description: 'ISO country code (de, fr, etc.)'
                            },
                            district: {
                                type: 'string',
                            ...
                            has_train_station: {
                                type: 'boolean',
                                description: 'Whether FlixTrain is available'
                            },
                            is_flixbus_city: {
                                type: 'boolean',
                                description: 'Whether FlixBus serves this city'
                            },
                            score: {
                                type: 'number',
        ...
        autocompleteStations: {
            ...
            tests: [
                {
                    _description: 'Search for Berlin stations',
                    q: 'Berlin',
                    lang: 'en',
                    country: 'de'
                },
                {
                    _description: 'Search for Hamburg stations',
                    q: 'Hamburg',
                    lang: 'en',
                    country: 'de'
                }
                ...
                schema: {
                    ...
                    items: {
                        ...
                        properties: {
                            ...
                            name: {
                                type: 'string',
                                description: 'Station name (e.g. Berlin central bus station)'
                            },
                            address: {
                                type: 'string',
                            ...
                            is_train: {
                                type: 'boolean',
                                description: 'Whether this is a train station'
                            },
                            importance_order: {
                                type: 'number',
                                description: 'Station importance ranking'
                            },
                            score: {
                                type: 'number',
        ...
        searchTrips: {
            ...
            parameters: [
                ...
                },
                {
                    ...
                    z: {
                        primitive: 'string()',
                        options: ['optional()', 'default({"adult":1})']
                    }
                },
                {
                    position: {
                    ...
                    z: {
                        primitive: 'enum(cities,stations)',
                        options: ['optional()', 'default(cities)']
                    }
                },
                {
                    position: {
                    ...
                    z: {
                        primitive: 'string()',
                        options: ['optional()', 'default(EUR)']
                    }
                }
            ],
            tests: [
                {
                    _description: 'Search Berlin to Munich trips',
                    from_city_id: '40d8f682-8646-11e6-9066-549f350fcb0c',
                    to_city_id: '40de8964-8646-11e6-9066-549f350fcb0c',
                ...
                {
                    _description: 'Search Hamburg to Berlin trips',
                    from_city_id: '40d91e53-8646-11e6-9066-549f350fcb0c',
                    to_city_id: '40d8f682-8646-11e6-9066-549f350fcb0c',
                        ...
                        trips: {
                            ...
                            items: {
                                ...
                                properties: {
                                    departure_city_id: {
                                        type: 'string',
                                        description: 'Departure_city_id value'
                                    },
                                    arrival_city_id: {
                                        type: 'string',
                                        description: 'Arrival_city_id value'
                                    },
                                    date: {
                                        type: 'string',
                                ...
                                description: 'Individual item in the trips collection'
                            },
                            description: 'Collection of trips items'
                        }
                    }
                }
            }

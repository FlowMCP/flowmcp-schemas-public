export const main = {
    ...
    tools: {
        ...
        getStop: {
            method: 'GET',
            path: '/stops/:stopId',
            description: 'Get detailed information about a specific stop/station by its VBB stop ID including name, coordinates, available products, and connected lines.. Use searchLocations first to find valid IDs',
            parameters: [
        ...
        getRadar: {
            method: 'GET',
            path: '/radar',
            description: 'Get real-time positions of vehicles in a geographic bounding box. Returns active vehicles with their current coordinates, line info, and trip details. Only available for VBB network.. Use searchLocations first to find valid IDs',
            parameters: [
        ...
        getReachableFrom: {
            ...
            description: 'Find stops reachable from a given location within a travel time limit. Requires address, latitude, and longitude. Returns stops grouped by travel duration.. Use searchLocations first to find valid IDs',
            parameters: [

export const main = {
    ...
    tools: {
        ...
        searchTrips: {
            method: 'GET',
            path: '/trips',
            description: 'Search for currently running trips by line name, operator, or stop. Returns active vehicles with real-time positions and stopovers. VBB-exclusive endpoint.. Use IDs from results in getTrip',
            parameters: [
        ...
        getLines: {
            method: 'GET',
            path: '/lines',
            description: 'Search and filter VBB transit lines by name, operator, or transport mode. Returns line details with route variants.. Use IDs from results in getLine',
            parameters: [
        ...
        getLine: {
            method: 'GET',
            path: '/lines/:id',
            description: 'Get detailed information about a specific transit line including all route variants with stop sequences.. Use searchTrips first to find valid IDs',
            parameters: [
                { position: { key: 'id', value: '{{USER_PARAM}}', location: 'insert' }, z: { primitive: 'string()', options: [] } }
            ],
            tests: [
